...
public class DiaryTypeDao {
	...
	public List<DiaryType> diaryTypeCountList(Connection con)throws Exception{
		...
		String sql="SELECT min(t_diaryType.diaryTypeId) as diaryTypeId,typeName,COUNT(diaryId) as diaryCount FROM t_diary RIGHT JOIN t_diaryType ON t_diary.typeId=t_diaryType.diaryTypeId GROUP BY t_diaryType.typeName;";
